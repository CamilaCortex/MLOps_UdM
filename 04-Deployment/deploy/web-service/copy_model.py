...
Este mismo script se reutiliza, sin cambios, en batch-deploy/ y en
web-service/: en ambos casos copia hacia script_dir / "model", es decir
al directorio "model/" que está al lado de este archivo, sea cual sea
la carpeta donde se ejecute.
"""
...
def copy_latest_model():
    ...
    logging.info("Copiando modelo del pipeline al directorio local model/...")
